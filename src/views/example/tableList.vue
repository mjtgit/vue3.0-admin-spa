<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;margin-right:10px;" class="filter-item" placeholder="标题" v-model="listQuery.title">
      </el-input>
...
export default {
  ...
  methods: {
    ...
    getList() {
        ...
        // })
        global.fetchGet(api.tableList,that.listQuery).then(res =>{
